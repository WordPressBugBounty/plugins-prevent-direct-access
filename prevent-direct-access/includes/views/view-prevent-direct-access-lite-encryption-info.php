<tr class="pda-gray-out">
	...
	<td>
		<p>
			<label><?php _e( 'Encrypt Protected Files', 'prevent-direct-access-gold' ); ?>
			...
			<?php _e( 'Prevent unauthorized downloads from viewing protected files by', 'prevent-direct-access-gold' ); ?>
			<a rel="noopener noreferrer" target="_blank" href="https://preventdirectaccess.com/docs/encrypt-wordpress-media-files/?utm_source=user-website&utm_medium=setting-general&utm_campaign=pda-gold">
				<?php _e( 'advanced encryption', 'prevent-direct-access-gold' ); ?>
			</a>
		</p>
	</td>
</tr>
